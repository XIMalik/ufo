...
export default function UIDesigns() {
  return (
    <div>
      <div className="containe z-0 flex flex-col justify-center items-center mt-5 py-5 overflow-hidden">
          ...
          <div className="work flex flex-wrap justify-center gap-1 col-span-6 p-10">
            <div className="item md:w-[300px] md:h-[200px] w-[350px] h-[250px] rounded-lg overflow-hidden">
              <img
                src={phone}
                alt=""
                className="w-[100%] object-cover ease-in-out duration-700 hover:-translate-y-[450px]"
              />
            </div>
            <div className="item md:w-[300px] md:h-[200px] w-[350px] h-[250px] rounded-lg overflow-hidden">
              <img
                src={gar}
                alt=""
                className="w-[100%] object-cover ease-in duration-200 hover:-translate-y-6"
              />
            </div>
            <div className="item md:w-[300px] md:h-[200px] w-[350px] h-[250px]  rounded-lg overflow-hidden">
              <img
                src={car}
                alt=""
                className="w-[100%] object-cover ease-in duration-700 hover:-translate-y-[450px]"
              />
            </div>
            <div className="item md:w-[300px] md:h-[200px] w-[350px] h-[250px] rounded-lg overflow-hidden">
              <img
                src={web}
                alt=""
                className="w-[100%] object-cover ease-in duration-300 hover:-translate-y-[70px]"
              />
            </div>
            <div className="item md:w-[300px] md:h-[200px] w-[350px] h-[250px]  rounded-lg overflow-hidden">
              <img
                src={mercy}
                alt=""
                className="w-[100%] object-cover ease-in duration-700 hover:-translate-y-[100px]"
              />
            </div>
            <div className="item md:w-[300px] md:h-[200px] w-[350px] h-[250px]  rounded-lg overflow-hidden">
              <img
          ...
          <div className=" grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 max-w-[1024px] p-10">
            <div className="col-span-1 h-[300px] overflow-hidden ease-in-out duration-300 bg-white hover:bg-blue-200 p-5 rounded-lg">
              <img
                src={acq}
                alt=""
                className="w-[100%] object-cover ease-in-out duration-[5s] hover:-translate-y-[650px]"
              />
            </div>
            <div className="col-span-1 h-[300px] overflow-hidden ease-in-out duration-300 bg-white hover:bg-green-200 p-5 rounded-lg">
              <img
                src={bank}
                alt=""
                className=" w-[100%] object-cover ease-in-out duration-700 hover:-translate-y-28 md:hover:-translate-y-2 sm:hover:-translate-y-16"
              />
            </div>
            <div className="col-span-1 h-[300px] overflow-hidden ease-in-out duration-700 bg-white hover:bg-slate-400 p-5 rounded-lg">
              <img
                src={carr}
                alt=""
                className="w-[100%] object-cover ease-in-out duration-700 hover:-translate-y-28 lg:hover:-translate-y-40 md:hover:-translate-y-72 sm:hover:-translate-y-32"
              />
            </div>
          </div>
        </div>
