    ...
    <div>
        <div className="containe z-0 flex flex-col justify-center items-center mt-5">
            <div className='w-[100%] max-w-[1024px] grid grid-cols-6 place-items-center ease-in duration-200 py-5 border-[0.5px] border-b-0 border-slate-100'>
                <span className='col-span-6 text-black text-xs px-5 border-r-[0.5px] border-l-[0.5px] border-dashed border-slate-500'>Some of my work</span>
            ...
            <div className='flex flex-col items-center align-center justify-center py-5 ease-in duration-200 bg-green-50'>
                <span className='text-black text-xs px-5 border-r-[0.5px] border-l-[0.5px] border-dashed border-slate-500'>User Interface Designs</span>
